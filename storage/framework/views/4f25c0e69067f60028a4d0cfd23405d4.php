...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top py-3">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            ...
            <form class="d-flex mx-auto mt-3 mt-lg-0 mb-3 mb-lg-0 position-relative search-container" action="<?php echo e(route('catalog.index')); ?>" method="GET">
            ...
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                <li class="nav-item">
                    <a class="nav-link fw-semibold d-flex align-items-center link-custom" href="<?php echo e(route('catalog.index')); ?>">
                ...
                <div class="d-flex align-items-center gap-1">
                    <li class="nav-item">
                        <a class="nav-link position-relative px-2" href="<?php echo e(route('wishlist.index')); ?>">
                            <i class="bi bi-heart fs-5 text-dark"></i>
                            <?php $wishlistCount = auth()->user()->wishlists()->count(); ?>
                            <span class="badge-custom <?php echo e($wishlistCount > 0 ? '' : 'd-none'); ?>"><?php echo e($wishlistCount); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link position-relative px-2" href="<?php echo e(route('cart.index')); ?>">
                            <i class="bi bi-cart3 fs-5 text-dark"></i>
                            <?php $cartCount = auth()->user()->cart?->items()->count() ?? 0; ?>
                            <?php if($cartCount > 0): ?>
                            <span class="badge-custom" style="background-color: #6366f1;"><?php echo e($cartCount); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                </div>
                ...
                <li class="nav-item dropdown ms-lg-2">
                    <a class="nav-link dropdown-toggle p-0 shadow-none border-0" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="avatar-trigger-box d-flex align-items-center bg-white rounded-pill px-2 py-1 border shadow-sm">
                            <img src="<?php echo e(auth()->user()->avatar_url); ?>" class="rounded-circle me-1" width="28" height="28" style="object-fit: cover;">
                        ...
                        <li class="px-3 py-3 mb-2 bg-light rounded-4 mx-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="overflow-hidden">
                                    <h6 class="mb-0 fw-bold text-dark text-truncate" style="font-size: 0.9rem;"><?php echo e(auth()->user()->name); ?></h6>
                                    <small class="text-muted d-block text-truncate" style="font-size: 0.75rem;"><?php echo e(auth()->user()->email); ?></small>
                                </div>
                            </div>
                        </li>
                        <li><a class="dropdown-item rounded-3 py-2" href="<?php echo e(route('profile.edit')); ?>"><i class="bi bi-person me-2 text-indigo"></i> Profil</a></li>
                        <li><a class="dropdown-item rounded-3 py-2" href="<?php echo e(route('orders.index')); ?>"><i class="bi bi-box-seam me-2 text-indigo"></i> Pesanan</a></li>
                        <?php if(auth()->user()->isAdmin()): ?>
                        <li><hr class="dropdown-divider opacity-50"></li>
                        <li><a class="dropdown-item rounded-3 py-2 fw-bold text-indigo" href="<?php echo e(route('admin.dashboard')); ?>"><i class="bi bi-speedometer2 me-2"></i> Admin Panel</a></li>
                        <?php endif; ?>
                        <li><hr class="dropdown-divider opacity-50"></li>
                        <li>
                ...
                <?php else: ?>
                <li class="nav-item"><a class="nav-link text-dark fw-bold px-3" href="<?php echo e(route('login')); ?>">Masuk</a></li>
                <li class="nav-item"><a class="btn btn-indigo-premium rounded-pill px-4 shadow-sm text-white" href="<?php echo e(route('register')); ?>">Daftar</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
