        ...
        <div class="col-md-5">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden login-card">
                ...
                <div class="card-header bg-transparent border-0 pt-5 pb-4 text-center">
                    <div class="mb-2">
                        <a href="<?php echo e(url('/')); ?>" class="brand-text-login d-flex align-items-center justify-content-center">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" 
                                class="form-control form-control-lg rounded-3 login-input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?> shadow-none" 
                                value="<?php echo e(old('email')); ?>" required autofocus placeholder="email@contoh.com">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="text-decoration-none small fw-bold" href="<?php echo e(route('password.request')); ?>" style="color: #6366f1;">Lupa?</a>
                                <?php endif; ?>
                            </div>
                            <input type="password" name="password" 
                                class="form-control form-control-lg rounded-3 login-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> shadow-none" 
                        ...
                        <div class="d-grid">
                            <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-google-pro rounded-pill py-2 d-flex align-items-center justify-content-center fw-bold shadow-none">
                ...
                <div class="card-footer border-0 py-4 text-center" style="background: var(--dropdown-info);">
                    <p class="mb-0 small" style="color: var(--login-text-muted);">
                        Belum punya akun? 
                        <a href="<?php echo e(route('register')); ?>" class="fw-bold text-decoration-none ms-1" style="color: #6366f1;">Daftar Sekarang</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gadget-murah\resources\views/auth/login.blade.php ENDPATH**/ ?>