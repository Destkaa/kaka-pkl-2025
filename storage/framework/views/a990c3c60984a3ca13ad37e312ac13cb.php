                ...
                <tr>
                    ...
                    <td class="pe-4 text-end">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="btn-action btn-action-view" title="Detail">
                                <i class="bi bi-eye"></i>
                            </a>
                            
                            <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="btn-action btn-action-edit" title="Edit">
