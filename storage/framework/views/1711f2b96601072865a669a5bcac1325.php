                ...
                <div class="card-body p-0">
                                ...
                                <tbody class="border-top-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <?php if($item->price < $item->product->price): ?>
                    ...
                    <div class="row g-0 border-top">
                        ...
                        <div class="col-md-5 p-4">
                            ...
                            <?php
                                // Hitung Subtotal Harga Asli vs Harga Bayar untuk memunculkan "Hemat"
                                $totalOriginal = $order->items->sum(function($item) {
                                    return $item->product->price * $item->quantity;
                                });
                                $totalPaidItems = $order->items->sum('subtotal');
                                $savings = $totalOriginal - $totalPaidItems;
                            ?>

                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-secondary small">Subtotal Produk</span>
                                <span class="text-dark">Rp <?php echo e(number_format($totalOriginal, 0, ',', '.')); ?></span>
                            </div>

                            <?php if($savings > 0): ?>
                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-success small fw-bold">Hemat Belanja</span>
                                <span class="text-success fw-bold">-Rp <?php echo e(number_format($savings, 0, ',', '.')); ?></span>
                            </div>
                            <?php endif; ?>
                ...
                <div class="card-footer bg-white border-top-0 p-4 text-center">
                    <div class="alert alert-info border-0 rounded-4 py-3 mb-4 small text-start">
                        <div class="d-flex">
                            ...
                            <div>
                                <strong>Menunggu Pembayaran:</strong> Selesaikan transaksi Anda melalui tombol di bawah.
                            </div>
                        </div>
                    </div>
        ...
        if (payButton) {
            payButton.addEventListener('click', function () {
                ...
                window.snap.pay('<?php echo e($order->snap_token); ?>', {
                    onSuccess: function (result) { window.location.href = '<?php echo e(route("orders.success", $order)); ?>'; },
                    onPending: function (result) { window.location.href = '<?php echo e(route("orders.pending", $order)); ?>'; },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gadget-murah\resources\views/orders/show.blade.php ENDPATH**/ ?>