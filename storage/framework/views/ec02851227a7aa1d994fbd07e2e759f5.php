            ...
            <div class="row align-items-center gy-5">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="<?php echo e(route('catalog.index')); ?>" class="btn btn-primary btn-pill shadow-sm">
                             Mulai Belanja
                        </a>
                        ...
                        <a href="<?php echo e(route('catalog.index', ['category' => $category->slug])); ?>" class="text-decoration-none text-dark">
                            <div class="card custom-card shadow-sm text-center h-100 p-3">
                                <div class="card-body p-0">
                                    ...
                                    <h6 class="fw-bold mb-1"><?php echo e($category->name); ?></h6>
                                    <span class="badge bg-light text-muted fw-normal"><?php echo e($category->products_count); ?> Produk</span>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="promo-banner bg-info text-white p-5 shadow-sm h-100 d-flex flex-column justify-content-center">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-pill w-fit">Daftar Akun</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding">
        <div class="container">
            <div class="d-flex justify-content-between align-items-end mb-5">
                ...
                <a href="<?php echo e(route('catalog.index')); ?>" class="btn btn-link text-decoration-none fw-bold">
