        ...
        <div class="flex-grow-1">
            <header class="bg-white shadow-sm py-3 px-4 d-flex justify-content-between align-items-center sticky-top">
                <div class="d-flex align-items-center">
                    <h4 class="mb-0 fw-bold me-3"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h4>
                ...
                <div class="d-flex align-items-center gap-2">
                    <span class="text-muted small d-none d-md-block me-2"><?php echo e(now()->format('d M Y')); ?></span>
