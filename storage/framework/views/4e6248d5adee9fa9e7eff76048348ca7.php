    ...
    <div class="card shadow-sm mb-5 border-0 filter-section">
        <form method="GET" class="row align-items-end g-3">
            ...
            <div class="col-md-6 d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.reports.export-sales', request()->all())); ?>" class="btn btn-success px-4 rounded-pill fw-bold shadow-sm">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $byCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                <span class="fw-bold text-secondary" style="font-size: 0.9rem;"><?php echo e($cat->name); ?></span>
                                <span class="fw-bold text-dark">Rp <?php echo e(number_format($cat->total, 0, ',', '.')); ?></span>
                            </div>
                            ...
                            <small class="text-muted mt-1 d-block"><?php echo e(number_format($percentage, 1)); ?>% dari total pendapatan</small>
                        </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="order-link fw-bold">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-muted" style="font-size: 0.75rem;"><?php echo e($order->user->email); ?></div>
                                    </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gadget-murah\resources\views/admin/reports/sales.blade.php ENDPATH**/ ?>