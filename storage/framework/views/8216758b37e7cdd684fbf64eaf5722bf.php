...
<div class="list-group">
    ...
    <div class="list-group-item d-flex justify-content-between align-items-center p-3">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-outline-primary btn-sm">
            Hubungkan
        </a>
        <?php endif; ?>
    </div>
</div><?php /**PATH C:\xampp\htdocs\gadget-murah\resources\views/profile/partials/connected-accounts.blade.php ENDPATH**/ ?>