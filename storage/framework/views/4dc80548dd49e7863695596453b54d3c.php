...
Terima kasih! Pembayaran untuk pesanan **#<?php echo new \Illuminate\Support\EncodedHtmlString($order->order_number); ?>** telah kami terima.
...
| <?php echo new \Illuminate\Support\EncodedHtmlString($item->product_name); ?> | <?php echo new \Illuminate\Support\EncodedHtmlString($item->quantity); ?> | Rp <?php echo new \Illuminate\Support\EncodedHtmlString(number_format($item->price, 0, ',', '.')); ?> |
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => $__env->getContainer()->make(Illuminate\View\Factory::class)->make('mail::button'),'data' => ['url' => route('orders.show', $order)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('orders.show', $order))]); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\gadget-murah\resources\views/emails/orders/paid.blade.php ENDPATH**/ ?>