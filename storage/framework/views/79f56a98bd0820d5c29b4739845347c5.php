            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 text-center">
                <div class="card-body p-4">
                    ...
                    <div class="text-start">
                        ...
                        <p class="small fw-medium text-dark"><?php echo e($order->address ?? 'Alamat tidak tersedia'); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="<?php echo e(route('admin.orders.updateStatus', $order->id)); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select border-0 bg-light rounded-3 fw-medium">
                                ...
                                <option value="completed" <?php echo e($order->status == 'completed' || $order->status == 'delivered' ? 'selected' : ''); ?>>Completed</option>
