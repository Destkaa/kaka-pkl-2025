...
# Halo, <?php echo e($order->user->name); ?>


Terima kasih! Pembayaran untuk pesanan **#<?php echo e($order->order_number); ?>** telah kami terima.
...
| <?php echo e($item->product_name); ?> | <?php echo e($item->quantity); ?> | Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?> |
