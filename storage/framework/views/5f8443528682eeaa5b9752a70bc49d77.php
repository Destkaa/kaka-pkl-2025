        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="<?php echo e(route('catalog.index')); ?>" class="text-secondary text-decoration-none">
                            Katalog Produk
                        </a>
                    </li>
                    <li class="mb-2">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start">
                <p class="text-secondary mb-0 small">
                    &copy; <?php echo e(date('Y')); ?> TokoOnline. All rights reserved.
                </p>
            </div>
            <div class="col-md-6 text-center text-md-end mt-3 mt-md-0">
                <img src="<?php echo e(asset('images/payment-methods.png')); ?>" alt="Payment Methods" height="30">
            </div>
        </div>
    </div>
</footer><?php /**PATH C:\xampp\htdocs\gadget-murah\resources\views/partials/footer.blade.php ENDPATH**/ ?>