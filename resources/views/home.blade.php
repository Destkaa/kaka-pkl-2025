...
@push('styles')
{{-- Memastikan Bootstrap Icons Versi Terbaru untuk ikon -fill --}}
...
@section('content')
    {{-- 1. Hero Section dengan Gambar Samar --}}
                        ...
                        <a href="{{ route('catalog.index', ['category' => $category->slug]) }}" class="text-decoration-none text-dark">
                            <div class="card custom-card text-center h-100 p-4 shadow-sm border-0">
                                <div class="mx-auto mb-3" style="width: 70px; height: 70px; background: var(--gadget-soft); border-radius: 18px; display: flex; align-items: center; justify-content: center;">
                                    <i class="bi {{ $icon }}" style="font-size: 2rem; color: var(--gadget-purple);"></i>
                                </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="p-5 h-100 d-flex flex-column justify-content-center text-white" 
                        ...
                        <a href="{{ route('catalog.index') }}" class="btn btn-warning btn-pill w-fit fw-bold text-dark text-decoration-none">Gunakan Promo</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="p-5 h-100 d-flex flex-column justify-content-center text-white" 
                        ...
                        <a href="{{ route('register') }}" class="btn btn-light btn-pill w-fit text-dark fw-bold text-decoration-none">Daftar Member</a>
                    </div>
                </div>
            </div>
        </div>
