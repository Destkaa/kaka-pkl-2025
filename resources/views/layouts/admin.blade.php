...
<head>
    ...
    <style>
        ...
        /* Reset Link & Focus (Anti Garis Biru) */
        a, button { text-decoration: none !important; outline: none !important; box-shadow: none !important; }
        ...
        <div class="flex-grow-1">
            <header class="bg-white shadow-sm py-3 px-4 d-flex justify-content-between align-items-center sticky-top">
                ...
                <div class="d-flex align-items-center gap-3">
                    <span class="text-muted small d-none d-lg-block">{{ now()->format('d M Y') }}</span>
                    
                    {{-- TOMBOL LIHAT TOKO (Di Sisi Logout) --}}
                    <a href="/" target="_blank" class="btn btn-sm btn-header-store rounded-pill px-3">
